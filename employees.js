...
class Employee{
    ...
    {
        return(`${this.name} works ${this.shifts}`)
    }
}
...
//CODE HERE
const empTwo = Object.assign({}, empOne)
empTwo.name = "Nick"
...
//CODE HERE
let LucasShifts = ["weekday mornings","weekday afternoons"]
let CurrentEmployeeList = ["Cece", "Schmidt"]
let newEmployee = "Alex"
const manager = new Manager("Lucas",LucasShifts, CurrentEmployeeList)
